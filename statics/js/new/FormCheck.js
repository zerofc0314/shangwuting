jQuery.extend({
    ...
    isMobile: function (_str) {
        return /^1[3|4|5|8][0-9]\d{8}$/.test(_str);
...
function showMessage(obj, message) {
        ...
        obj.parent().append("<div class='alert' style='color:red;font-size:12px;padding-left:10px;'></div>");
        obj.parent().find(".alert").html(message);
    }