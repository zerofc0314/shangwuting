...
#content{width:950px;min-height:540px; margin:auto; padding:36px 0 20px 0; overflow:hidden;}
.form-login{width:420px; padding-left:40px}
#content h2{font-size:25px;color:#494949;border-bottom: 1px dashed #999;padding-bottom:3px; margin-bottom:10px}
