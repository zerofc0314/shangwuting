<?php defined('IN_PHPCMS') or exit('No permission resources.'); ?><div class="col-left col-1 left-memu">
            ...
            <ul>
       	    <li <?php if(ROUTE_A=="publish") { ?> class="on"<?php } ?>><a href="index.php?m=member&c=content&a=publish"><img src="<?php echo IMG_PATH;?>icon/m_2.png" width="14" height="15" /> 在线提问<!--<?php echo L('online_publish');?>--></a></li>
            <li <?php if(ROUTE_A=="published") { ?> class="on"<?php } ?>><a href="index.php?m=member&c=content&a=published"><img src="<?php echo IMG_PATH;?>icon/m_3.png" width="14" height="16" /> 我的问题<!--<?php echo L('published_content');?>--></a></li>
            <li <?php if(ROUTE_A=="publishedCapital") { ?> class=""<?php } ?>><a href="index.php?m=member&c=content&a=publishedCapital"><img src="<?php echo IMG_PATH;?>icon/m_3.png" width="14" height="16" /> 资金申报</a></li>
            <li <?php if(ROUTE_A=="publishedJoin") { ?> class=""<?php } ?>><a href="index.php?m=member&c=content&a=publishedJoin"><img src="<?php echo IMG_PATH;?>icon/m_3.png" width="14" height="16" /> 展会展厅</a></li>
            <li <?php if(ROUTE_A=="published") { ?> class=""<?php } ?>><a href="index.php?m=member&c=content&a=published"><img src="<?php echo IMG_PATH;?>icon/m_3.png" width="14" height="16" /> 我的培训</a></li>
            </ul>
