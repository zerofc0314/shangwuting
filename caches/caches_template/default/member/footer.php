...
<p class="cp">Powered by <strong><a href="http://www.phpcms.cn" target="_blank">江西南昌</a></strong> <em></em> &copy; <?php echo date('Y', SYS_TIME);?> <img src="<?php echo IMG_PATH;?>copyright.gif"/>
</p>
</div>
</body>
</html>