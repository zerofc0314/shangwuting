...
#content{width:950px; margin:auto; padding:36px 0 0 0}
.form-login{ width:440px; padding-left:20px}
.form-login h2{font-size:25px;color:#494949;border-bottom: 1px dashed #999;padding-bottom:9px; margin-bottom:30px}
...
.col-1{position:relative; float:right;right:30px; border:1px solid #c4d5df; zoom:1;background: url(<?php echo IMG_PATH;?>member/member_title.png) repeat-x; width:310px; margin: auto; height:304px}
.col-1 span.o1,
	.col-1 span.o2,
	.col-1 span.o3,
...
<input type="hidden" name="forward" id="forward" value="<?php echo $forward;?>">
        ...
        <div class="hr"><hr /></div>
        <div class="reg">你还没有注册江西外贸商务厅的会员？<br />
