...
<div style=" margin:auto;width:994px;">
            <div class="pt_body  clear" id="piclist" style="overflow:hidden;height:50px;">
                    ...
                    <ul class="picScroll1">
                         ...
                         <li>
                             <a href="<?php echo $v['url'];?>" target="_blank">
                                 <img src="<?php echo $v['logo'];?>" style="width:150px; height:50px;"/>
                             </a>
                         </li>
                        <?php $n++;}unset($n); ?>
